...
#import groupss
group_3rd = read.csv("three_cluster_groups_la.csv")
View(group_3rd)
group5_3rd = read.csv("five_cluster_groups_la.csv")
View(group5_3rd)

#import original NDVI values
third_case = read.csv("Book2.csv",header = FALSE)
...
write.csv(rank_pc1,"threeclusters_secondcase_1stgroup.csv", row.names = FALSE)

print(tail(rank_pc1_2,10))
write.csv(rank_pc1_2,"threeclusters_secondcase_2ndgroup.csv", row.names = FALSE)

print(tail(rank_pc1_3,10))
write.csv(rank_pc1_3,"threeclusters_secondcase_3rdgroup.csv", row.names = FALSE)
...
write.csv(rank_pc1_5,"fiveclusters_secondcase_1stgroup.csv", row.names = FALSE)

print(tail(rank_pc1_2_5,10))
write.csv(rank_pc1_2_5,"fiveclusters_secondcase_2ndgroup.csv", row.names = FALSE)

print(tail(rank_pc1_3_5,10))
write.csv(rank_pc1_3_5,"fiveclusters_secondcase_3rdgroup.csv", row.names = FALSE)

print(tail(rank_pc1_4_5,10))
write.csv(rank_pc1_4_5,"fiveclusters_secondcase_4thgroup.csv", row.names = FALSE)

print(tail(rank_pc1_5_5,10))
write.csv(rank_pc1_5_5,"fiveclusters_secondcase_5thgroup.csv", row.names = FALSE)
